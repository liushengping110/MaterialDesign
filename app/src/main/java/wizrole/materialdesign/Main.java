...
import wizrole.materialdesign.likeUc.LikeUcActivity;
...
public class Main extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        findViewById(R.id.like_uc).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(Main.this, LikeUcActivity.class);
                startActivity(intent);
            }
        });
    }
